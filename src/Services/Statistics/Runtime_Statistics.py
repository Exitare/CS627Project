...
def get_application_stats():
    ...
    end_time = time.time()
    if end_time - application_start_time > 60:
        logging.info(f"Time passed: {(end_time - application_start_time) / 60} minutes.")
    else:
        logging.info(f"Time passed: {end_time - application_start_time} seconds.")
